<template>
  <div>
    ...
    <el-dialog title="赞赏" :visible.sync="showAdmireDialog" width="25%" :append-to-body="true" destroy-on-close center>
      <div>
        <div class="admire-image">

        </div>
        <div>
          <div class="admire-content"></div>
        </div>
      </div>
    </el-dialog>
  </div>
...
.admire-box {
  background: url(https://cdn.zhujunpeng.love/randomCover/Jun11702547575607687.jpg) no-repeat;
  padding: 25px;
  border-radius: 10px;
...
.admire-image {
  ...
  height: 150px;
  width: 150px;
  background: url(https://cdn.zhujunpeng.love/wx.jpg);
